...
% aperture
aper = Aperture( [ 5 0 0 ], [ 10 15] ); % circular aperture
bench.append( aper );
...
diam3 = 5;
spRad2 = 6.18; 
lens1 = Lens( [pos2x  0 0 ], diam3, spRad2, cc, frontSurface );
% back lens surface
diam4 = diam3;
CT4 = 2.5;
lens2 = Lens( [ pos2x+CT4 0 0 ], diam4, -spRad2, cc, backSurface );
bench.append( { lens1, lens2 } );

% screen: 
screen = Screen( [ 20 0 0 ], 20, 20, 512, 512 );
bench.append( screen );
...
dv = zeros( npos, 1 );
scr_x = linspace( lens2.r(1) + 1, lens2.r(1) + 20, npos );
